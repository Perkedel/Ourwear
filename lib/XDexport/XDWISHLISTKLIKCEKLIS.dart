...
import './XDWISHLISTKLIKATUR.dart';
import 'package:adobe_xd/page_link.dart';
import './XDWISHLISTKLIKHAPUS.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDWISHLISTKLIKCEKLIS extends StatelessWidget {
  XDWISHLISTKLIKCEKLIS({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 125.0, 30.0),
                    size: Size(125.0, 30.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(20.0, 8.0, 86.0, 14.0),
                    size: Size(125.0, 30.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
          ...
          Transform.translate(
            offset: Offset(135.0, 673.0),
            child: Text(
              'Oversized Sweater Gray H&M',
              style: TextStyle(
                fontFamily: 'HelveticaNeue',
                fontSize: 13,
                color: const Color(0xff000000),
          ...
          Transform.translate(
            offset: Offset(135.0, 809.0),
            child: Text(
              'Baby Olive Romper Jumpsuit',
              style: TextStyle(
                fontFamily: 'HelveticaNeue',
                fontSize: 13,
                color: const Color(0xff000000),
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(156.0, 12.0, 48.0, 17.0),
                    size: Size(360.0, 40.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDWISHLISTKLIKATUR(),
                ),
              ],
              child: SvgPicture.string(
                _svg_pj7ij7,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDWISHLISTKLIKHAPUS(),
                ),
              ],
              child: Text(
                'Hapus',
...
const String _svg_n7mvn1 =
    '<svg viewBox="-0.5 249.5 362.0 544.0" ><path transform="translate(-0.5, 249.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(0.5, 385.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-0.5, 521.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-0.5, 657.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-0.5, 793.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
