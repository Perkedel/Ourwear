...
class XDUserTradeChatnawar extends StatelessWidget {
  XDUserTradeChatnawar({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(50.0, 234.0),
            child: Text(
              'Membuat Tawaran Rp 100.000',
              style: TextStyle(
                fontFamily: 'HelveticaNeue',
                fontSize: 11,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 83.0, 24.0),
                    size: Size(83.0, 37.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 26.0, 26.0, 11.0),
                    size: Size(83.0, 37.0),
                    pinLeft: true,
                    pinBottom: true,
                    fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 85.0, 20.0),
                    size: Size(85.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    pinTop: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(9.0, 4.0, 68.0, 12.0),
                    size: Size(85.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(9.0, 5.0, 68.0, 10.0),
                    size: Size(85.0, 20.0),
                    pinLeft: true,
                    pinRight: true,
                    fixedHeight: true,
