...
import './XDHOMEPAGEWANITA.dart';
import 'package:adobe_xd/page_link.dart';
import './XDSebelumLoginPilihanKelaminANAKANAK.dart';
import './XDSebelumLoginPilihanKelaminPRIA1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDSebelumLoginPilihanKelaminWanita extends StatelessWidget {
  XDSebelumLoginPilihanKelaminWanita({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDSebelumLoginPilihanKelaminANAKANAK(),
                ),
              ],
              child: SizedBox(
                width: 135.0,
