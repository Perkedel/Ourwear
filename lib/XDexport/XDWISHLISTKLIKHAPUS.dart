...
import './XDWISHLISTSETELAHHAPUS.dart';
import 'package:adobe_xd/page_link.dart';
import './XDWISHLIST.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDWISHLISTKLIKHAPUS extends StatelessWidget {
  XDWISHLISTKLIKHAPUS({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Transform.translate(
            offset: Offset(96.0, 298.0),
            child: Text(
              'Produk akan terhapus dari wishlist',
              style: TextStyle(
                fontFamily: 'Helvetica',
                fontSize: 10,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDWISHLISTSETELAHHAPUS(),
                ),
              ],
              child: SizedBox(
                width: 115.0,
...
const String _svg_tozijw =
    '<svg viewBox="-0.5 249.5 362.0 272.0" ><path transform="translate(-0.5, 249.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(0.5, 385.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(-0.5, 521.5)" d="M 0 0 L 361 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
