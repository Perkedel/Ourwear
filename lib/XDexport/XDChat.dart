...
import './XDTampilanChat.dart';
import './XDChatklikatur.dart';
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(60.0, 4.0, 81.0, 14.0),
                      size: Size(320.0, 50.0),
                      pinTop: true,
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(60.0, 23.0, 211.0, 14.0),
                      size: Size(320.0, 50.0),
                      fixedWidth: true,
                      fixedHeight: true,
                      child: Text(
                    ...
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(298.0, 6.0, 22.0, 10.0),
                      size: Size(320.0, 50.0),
                      pinRight: true,
                      pinTop: true,
                      fixedWidth: true,
