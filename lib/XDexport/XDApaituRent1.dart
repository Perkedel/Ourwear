...
class XDApaituRent1 extends StatelessWidget {
  XDApaituRent1({
    Key key,
  }) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Transform.translate(
            offset: Offset(-7.8, 362.0),
            child: SizedBox(
              width: 334.0,
              child: Text(
                'Cara Bertukar Produk Trade Pertama Kali!',
                style: TextStyle(
