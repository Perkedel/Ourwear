...
class XDFormPostingRentNamaProdukTrade extends StatelessWidget {
  XDFormPostingRentNamaProdukTrade({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_12ld9k =
    '<svg viewBox="20.5 138.5 340.0 1.0" ><path transform="translate(20.5, 138.5)" d="M 0 0 L 340 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
