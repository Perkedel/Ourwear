...
class XDFormPostingTrade extends StatelessWidget {
  XDFormPostingTrade({
    Key key,
  }) : super(key: key);
  @override
...
const String _svg_sdgu62 =
    '<svg viewBox="20.0 341.0 340.0 24.5" ><path transform="translate(20.0, 365.5)" d="M 0 0 L 340.0000305175781 0" fill="none" fill-opacity="0.4" stroke="#808080" stroke-width="0.5" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /><path transform="translate(323.41, 335.0)" d="M 10 6 L 8.590000152587891 7.409999847412109 L 13.17000007629395 12 L 8.590000152587891 16.59000015258789 L 10 18 L 16 12 L 10 6 Z" fill="#808080" fill-opacity="0.4" stroke="none" stroke-width="1" stroke-opacity="0.4" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
