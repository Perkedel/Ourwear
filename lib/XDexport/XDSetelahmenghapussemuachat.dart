...
class XDSetelahmenghapussemuachat extends StatelessWidget {
  XDSetelahmenghapussemuachat({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(39.0, 0.0, 90.0, 90.0),
                    size: Size(167.0, 138.0),
                    pinTop: true,
                    fixedWidth: true,
                    fixedHeight: true,
                    child:
                        // Adobe XD layer: 'ic_textsms_24px' (shape)
                        SvgPicture.string(
                      _svg_2lki8d,
                      allowDrawingOutsideViewBox: true,
                      fit: BoxFit.fill,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 105.0, 167.0, 16.0),
                    size: Size(167.0, 138.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(4.0, 126.0, 159.0, 12.0),
                    size: Size(167.0, 138.0),
                    pinLeft: true,
                    pinRight: true,
                    pinBottom: true,
                    fixedHeight: true,
                    child: Text(
                      'Yuk,mulai ajak ngobrol yang lain',
                      style: TextStyle(
                        fontFamily: 'Helvetica',
                        fontSize: 10,
                        color: const Color(0x66808080),
...
const String _svg_2lki8d =
    '<svg viewBox="136.0 251.0 90.0 90.0" ><path transform="translate(134.0, 249.0)" d="M 83 2.000000476837158 L 11 2.000000476837158 C 6.050000667572021 2.000000476837158 2.045000076293945 6.050000667572021 2.045000076293945 11 L 2.000000476837158 92 L 20.00000190734863 74 L 83 74 C 87.95000457763672 74 92 69.94999694824219 92 65 L 92 11 C 92 6.050000667572021 87.95000457763672 2.000000476837158 83 2.000000476837158 Z M 33.49999618530273 42.5 L 24.5 42.5 L 24.5 33.49999618530273 L 33.49999618530273 33.49999618530273 L 33.49999618530273 42.5 Z M 51.49999618530273 42.5 L 42.5 42.5 L 42.5 33.49999618530273 L 51.49999618530273 33.49999618530273 L 51.49999618530273 42.5 Z M 69.5 42.5 L 60.49999618530273 42.5 L 60.49999618530273 33.49999618530273 L 69.5 33.49999618530273 L 69.5 42.5 Z" fill="#808080" fill-opacity="0.3" stroke="none" stroke-width="1" stroke-opacity="0.3" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
