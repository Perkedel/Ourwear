...
import './XDRentBestSellerPria.dart';
import './XDTradeBestSellerPria.dart';
import './XDRentUtukKamuPria.dart';
import './XDTradeUntukKamuPria.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDHOMEPAGEPRIA extends StatelessWidget {
  XDHOMEPAGEPRIA({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              ...
              child: SizedBox(
                ...
                child: Stack(
                  children: <Widget>[
                    Pinned.fromSize(
                      bounds: Rect.fromLTWH(12.0, 57.0, 26.0, 16.0),
                      size: Size(50.1, 73.0),
                      pinBottom: true,
                      fixedWidth: true,
                      fixedHeight: true,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDRentBestSellerPria(),
                ),
              ],
              child: SizedBox(
                width: 63.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDTradeBestSellerPria(),
                ),
              ],
              child: SizedBox(
                width: 63.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDRentUtukKamuPria(),
                ),
              ],
              child: SizedBox(
                width: 63.0,
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDTradeUntukKamuPria(),
                ),
              ],
              child: SizedBox(
                width: 63.0,
...
const String _svg_11htyc =
    '<svg viewBox="310.8 10.0 19.5 13.8" ><path transform="translate(309.79, 5.55)" d="M 1 8.489261627197266 L 2.775623559951782 10.26488590240479 C 7.188045978546143 5.852461814880371 14.34380626678467 5.852461814880371 18.75622749328613 10.26488590240479 L 20.53185081481934 8.489261627197266 C 15.14283752441406 3.100245952606201 6.397894382476807 3.100245952606201 1 8.489261627197266 Z M 8.102492332458496 15.59175300598145 L 10.7659273147583 18.25518798828125 L 13.42936134338379 15.59175300598145 C 11.96447372436523 14.11798763275146 9.576260566711426 14.11798763275146 8.102492332458496 15.59175300598145 Z M 4.551246166229248 12.0405101776123 L 6.326869010925293 13.81613159179688 C 8.777230262756348 11.36577224731445 12.75462532043457 11.36577224731445 15.20498371124268 13.81613159179688 L 16.98060417175293 12.0405101776123 C 13.55365467071533 8.613556861877441 7.987075805664063 8.613556861877441 4.551246166229248 12.0405101776123 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
