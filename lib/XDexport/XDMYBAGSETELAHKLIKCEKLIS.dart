...
import './XDMYBAGKLIKATUR.dart';
import 'package:adobe_xd/page_link.dart';
import './XDMYBAGSETELAHKLIKCEKLIS1.dart';
import 'package:flutter_svg/flutter_svg.dart';

class XDMYBAGSETELAHKLIKCEKLIS extends StatelessWidget {
  XDMYBAGSETELAHKLIKCEKLIS({
    Key key,
  }) : super(key: key);
  @override
            ...
            child: PageLink(
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => XDMYBAGSETELAHKLIKCEKLIS1(),
                ),
              ],
              child: Text(
                'Hapus',
